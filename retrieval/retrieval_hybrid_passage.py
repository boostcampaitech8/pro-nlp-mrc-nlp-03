...
#         tokenize_fn,
#         data_path: str = "../data",
#         # 문서 단위가 아니라 passage 단위 위키 파일 사용
...
#     ):
#         """
#         Sparse(BM25) + Dense 하이브리드 검색 (passage 기반)

#         Arguments:
#             tokenize_fn: BM25에서 사용할 토크나이저 함수 (ex: tokenizer.tokenize)
#             data_path: 데이터 경로 (ex: ../data)
#             context_path: passage가 저장된 파일명 (wikipedia_passages_256_128.json)
#             dense_model: dense retriever로 사용할 모델 이름 (SentenceTransformer 호환)
#             alpha: BM25 가중치 (0~1, alpha가 클수록 BM25 비중 ↑)
#         """
...
#         """
#         단일 query에 대한 하이브리드 검색 (BM25 + Dense, passage 단위)
#         """
...
#                 "question": question,
#                 "id": example["id"],
#                 # top-k passage들을 하나의 context로 합침
#                 "context": " ".join(retrieved_contexts),
#             }

#             # 정답/원래 context가 있는 경우 hit 체크용으로 같이 보존
...
#     # ============================
#     print("\n" + "=" * 60)
#     print("단일 Query 테스트 (Hybrid + passage)")
#     print("=" * 60)
...
#                 # answers 가 리스트/문자열 둘 다 올 수 있으니 방어적으로 처리
...
#             val_df["hit"] = val_df.apply(has_answer, axis=1)
#             accuracy = val_df["hit"].mean()

#             print(f"✅ Hybrid (α={alpha}): {accuracy:.4f}")


#     print("\n" + "=" * 60)
#     print("기준선 (참고용, 아래 값들과 직접 비교 X)")
#     print("=" * 60)
#     print("BM25만(hit, document 기준): 84.17%")
#     print("Dense만(hit, document + ko-sroberta 기준): 47.08%")
#     print("→ 위 Hybrid 결과는 passage+answer 기준 hit이라 척도가 다름")
